...
parser.add_argument('--data_folder', default='cloud/Numerical/CWQ', type=str)
...
parser.add_argument('--load_num', default='../CWQ/rel_embedding.npy', type=str)
parser.add_argument('--relation_embedding_file', default='../CWQ/rel_embedding.npy', type=str)
parser.add_argument('--cache_dir', default='/home/fengyu/RoBERTa', type=str)
